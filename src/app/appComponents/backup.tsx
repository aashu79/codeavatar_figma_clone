...
import ThumbnailCarousel from "./detail/ThumbnailCarousel";
...
const Page = () => {
  ...
  const mediaItems = [
    { id: 1, thumbnail: "/placeholder-image.jpg" },
    { id: 2, thumbnail: "/placeholder-image.jpg" },
    { id: 3, thumbnail: "/placeholder-image.jpg" },
    { id: 4, thumbnail: "/placeholder-image.jpg" },
    { id: 5, thumbnail: "/placeholder-image.jpg" },
  ];
  ...
  return (
    ...
    >
      {/* Custom overlay */}
      <DialogOverlay className="fixed inset-0 bg-black/50 z-[9999] transition-opacity duration-300" />
              ...
              >
                ...
                <div className="modal-scale-container w-full h-full overflow-hidden">
                  ...
                  <div className="scale-modal-content flex flex-col lg:flex-row overflow-auto gap-[67px] px-[184px] py-[20px] relative">
                    ...
                    {/* Right sidebar */}
                    <div className="w-full lg:max-w-[394px] bg-white overflow-y-auto h-full border-l border-zinc-100">
